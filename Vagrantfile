...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "cbrwizard-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/minemart"
  #   chef.validation_client_name = "minemart-validator"
  #   chef.validation_key_path = ".chef/minemart-validator.pem"
  # end
end
